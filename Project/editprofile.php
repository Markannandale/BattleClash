<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!$error) {
      if (!empty($first_name) && !empty($last_name)) {
        // Only set the picture column if there is a new picture
          $query = "UPDATE battle_clash_user SET first_name = '$first_name', last_name = '$last_name' WHERE user_id = '" . $_SESSION['user_id'] . "'";
      }
    ...
    $query = "SELECT first_name, last_name FROM battle_clash_user WHERE user_id = '" . $_SESSION['user_id'] . "'";
